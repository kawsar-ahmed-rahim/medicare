    ...
    <div className={a.pageContainer}>
      ...
      <div className={a.gridContainer}>
        <div className={a.formContainer}>
          ...
          <p className={a.formSubtitle}>
            Fill the form - we will open whatsApp so you can connect with us.
          </p>
          <form onSubmit={handleSubmit} className={a.formSpace}>
            ...
            <div className={a.formGrid}>
              ...
              <div>
                ...
                {errors.department && (
                  <p className={a.error}>{errors.department}</p>
                )}
              </div>
            </div>
            <div>
              ...
              {errors.service && <p className={a.error}>{errors.service}</p>}
            </div>
            <div>
              <label className={a.label}>
              ...
              />
              {errors.message && <p className={a.error}>{errors.message}</p>}
            </div>
        ...
        <div className={a.infoContainer}>
          ...
          <iframe
            src="https://maps.google.com/maps?q=Dhanmondi,+Dhaka+1205,+Bangladesh&output=embed"
            className={a.map}
            title="Dhanmondi Map"
            loading="lazy"
            allowFullScreen
          ...
          <div className={a.hoursContainer}>
            ...
            <p className={a.hoursText}>Mon - sat: 9:00 AM - 6:00 PM</p>
          </div>
        </div>
      </div>
