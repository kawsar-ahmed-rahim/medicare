...
import { Calendar, Clock, Ribbon, ShieldUser, Star, Stethoscope, User } from "lucide-react";
const Banner = () => {
          ...
          <div className={a.flexContainer}>
            <div className={a.leftContent}>
              ...
              <p className={a.tagline}>
                Premium Healthcare
                <span className={`block ${a.taglineHighlight}`}>At Your Fingertips</span>
              </p>
              ...
              <div className={a.ctaButtonsContainer}><button onClick={()=> navigate("/doctors")} className={a.bookButton}>
